#+TITLE: annotated-completing-read.el -- completing-read with aligned annotations
#+OPTIONS: toc:2 num:nil

* Overview
A wrapper around =completing-read= that accepts a hash table or alist of
candidates to annotations and surfaces them as aligned completion metadata
understood by [[https://github.com/minad/vertico][vertico]] (and other minibuffer completion interfaces), [[https://github.com/oantolin/marginalia][marginalia]],
and [[https://github.com/oantolin/embark][embark]].

Also provides =annotated-completing-read-directory= for context-aware directory
selection and =annotated-completing-read-context-from-point= for populating
candidates from =thing-at-point=, the active region, the current line, and the
kill ring.
